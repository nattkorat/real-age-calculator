...
<head>
    ...
    <title>គណនាកាលបរិច្ឆេទ</title>
</head>

<body class="bg-light">
    <header class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid d-grid gap-3 align-items-center text-center">
            <h2 class="moul-regular text-light">ការគណនាអាយុពិត</h2>
        </div>
    </header>
        ...
        <div class="container">
            <form action="" method="post">
                <div class="row align-items-center justify-content-center">
                    <div class="col-sm-12 col-md-4 col-lg-5 text-center border border-secondary p-3 m-1 bg-white shadow-lg rounded" style="height: 13rem;">
                        <h4 class="card-title battambang-bold mb-5">កាលបរិច្ឆេទទី ១ (ថ្ងៃខែឆ្នាំកំណើត)</h4>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-5 text-center border border-secondary p-3 m-1 bg-white shadow-lg rounded" style="height: 13rem;">
                        <h4 class="card-title battambang-bold mb-5">កាលបរិច្ឆេទទី ២ (ថ្ងៃខែឆ្នាំបច្ចុប្បន្ន)</h4>
                ...
                <div class="row ">
                    <div class="col-auto m-auto"> 
                        <input type="submit" value="គណនា" class="btn btn-primary battambang-bold m-3 shadow-lg" style="width: 15rem; height: 3rem;">
                    </div> 
                </div>      
            </form>
        </div>
